...
public class Dao extends DBContext {
    ...
    public List<Dt> getAmountClassAtt(int id, String date) {
        ...
        String sql = """
                     select date, count(date) as cls
                     from Attendance a, userClass uc, Class c, Lecturer l
...
//        System.out.println(d.addSupport(s));
        s.getTs().getTitle();
        System.out.println(d.getAllSupportByAccountID(1016));
    }
}
